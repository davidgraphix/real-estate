...
const Footer = () => {
  return (
    ...
    >
      ...
      >
        <div className="w-full md:w-1/3 mb-8 md:mb-0">
          ...
          <p className="text-gray-400 mt-4">
            ...
            perferendis optio voluptas quae? Expedita, voluptatum quae.
          </p>
        </div>
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="text-gray-400 mb-4 max-w-80">
            The latest news, articles, and resources, nsent to your inbox
            Weekly.
          </p>
      ...
      >
        Copyright 2025 © Davidsmart Soft. All Right Reserved.
      </motion.div>
    </div>
  );
};
